                    ...
                    return (
                      <Link
                        ...
                        className={`
                          ...
                          ${projColor} sm:bg-gray-50 sm:dark:bg-slate-800/50 sm:text-navy-800 sm:dark:text-slate-200
                          sm:border-l-2 ${e.confirmed ? 'sm:border-emerald-500 sm:bg-emerald-50/40 sm:dark:bg-emerald-950/30' : 'sm:border-navy-400'}
                          hover:brightness-95
                        `}
