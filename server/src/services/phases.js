...
const BUILT_IN_ALIASES = Object.freeze({
  ...
  // 마무리 — 입주청소·실리콘·점검을 모두 흡수 (2026-05-13 통합)
  '입주청소': '마무리(입주청소·실리콘 등)', '청소': '마무리(입주청소·실리콘 등)', '준공청소': '마무리(입주청소·실리콘 등)',
  '실리콘': '마무리(입주청소·실리콘 등)', '점검': '마무리(입주청소·실리콘 등)', '하자보수': '마무리(입주청소·실리콘 등)',
  '마무리': '마무리(입주청소·실리콘 등)',
  ...
  // 전기 (2026-05-14 추가)
  '콘센트': '전기', '조명': '전기', '배선': '전기', '스위치': '전기',
  'LED': '전기', '전등': '전기', '인터폰': '전기', '분전반': '전기',
  // 설비 (2026-05-14 추가)
  '배관': '설비', '수도': '설비', '보일러': '설비', '위생설비': '설비',
  '정화조': '설비', '하수': '설비', '급수': '설비', '냉온수': '설비',
  // 가스 (2026-05-14 추가)
  'LPG': '가스', 'LNG': '가스', '가스공사': '가스',
  // 소방 (2026-05-14 추가)
  '스프링클러': '소방', '화재감지기': '소방', '감지기': '소방',
  // 목공 (2026-05-14 추가)
  '우물천장': '목공', '가벽': '목공', '몰딩': '목공', '목공사': '목공',
  // 도장 (2026-05-14 추가)
  '페인트': '도장', '페인팅': '도장', '래커': '도장', '락카': '도장',
  // 필름 (2026-05-14 추가)
  '시트지': '필름', '인테리어필름': '필름',
});
